...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__1(Vsinegen___024root* vlSelf) {
    ...
    // Body
    vlSelf->dout2 = vlSelf->sinegen__DOT__dual_sineRom__DOT__rom_array
        [(0xffU & ((IData)(0x40U) + (IData)(vlSelf->sinegen__DOT__address1)))];
    vlSelf->dout1 = vlSelf->sinegen__DOT__dual_sineRom__DOT__rom_array
